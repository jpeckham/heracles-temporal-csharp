...
Direct `POST /files/{id}/entries/full` requests must use an entry type of `Credit` or `Debit`, a positive amount, a routing number with exactly 9 digits, and a required account number of 17 characters or fewer.
